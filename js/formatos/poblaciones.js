...
function AgregarPoblacion(id_definicion) {
    ...
    var mujeres_ = $("#mujeres_"+id_definicion).val().trim();//aqui falla
    ...
    if (DescripcionPoblacion_ == ""  || hombres_ == "" || mujeres_ == "" || indigenas =="" || grupo_edad <= 0) {
        ...
        var data_recurso = {Descripcion:DescripcionPoblacion_,num_hombres:hombres_,num_mujeres:mujeres_,num_indigenas:indigenas,edad:grupo_edad,idPrograma:id_programa,definicion:id_definicion};
