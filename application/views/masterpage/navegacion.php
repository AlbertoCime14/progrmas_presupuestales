            ...
            <div id="menu" role="navigation">
                ...
                <ul class="navigation">
                        ...
                        <a href="javascript:void(0)">
                            ...
                            <span>Actividad presupuestal</span>
                        ...
                        <ul class="sub-menu">
                            <li class="<?php echo ($pag==1) ? 'active' : '' ; ?>" id="frm_1">
                                ...
                                <a href="<?=base_url();?>formatos/frm_5">
                                    <i class="fa fa-fw ti-file"></i>5. Identificación y cuantificación de la población objetivo
                                </a>
                            </li>
                                ...
                                <a href="<?=base_url();?>formatos/frm_7">
                                    <i class="fa fa-fw ti-file"></i>7. Criterios para la focalización de la población objetivo
                                </a>
                            </li>
                                    <li class="<?php echo ($pag==8) ? 'active' : '' ; ?>" id="frm_8">
                                <a href="<?=base_url();?>formatos/frm_8">
                                    <i class="fa fa-fw ti-file"></i>8. Características de los bienes o servicios del programa
                                </a>
                            </li>
